...
SKILLS: dict[str, dict[str, list[SourcePose]]] = {
    ...
    "Lance": {
        ...
        # 마무리는 대각선 준비 뒤 최대 신장을 유지해 일반 Attack2보다 큰 한 방으로 읽히게 합니다.
        "lance_finisher_thrust": [
            SourcePose("Idle", 4),
            SourcePose("Attack2", 0),
            SourcePose("Attack2", 1, x=1),
            SourcePose("Attack2", 3, x=4),
            SourcePose("Attack2", 4, x=7, y=1),
            SourcePose("Attack2", 4, x=8, y=1),
            SourcePose("Attack2", 5, x=4),
            SourcePose("Idle", 1, x=1),
            SourcePose("Idle", 0),
        ],
    },
    "Shield": {
